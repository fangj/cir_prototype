...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playground = __webpack_require__(5);
	...
	_reactDom2.default.render(_react2.default.createElement(_playground2.default, { env: env }), document.getElementById('root'));

	_pubsubJs2.default.subscribe("pos", function (msg, obj) {
	  // console.log(msg,obj);
	...
	_pubsubJs2.default.subscribe("line", function (msg, obj) {
	  // console.log(msg,obj);
	...
	var playground = function (_React$Component) {
	  ...
	  _createClass(playground, [{
	    ...
	    value: function render() {
	      ...
	      var pstr = "M" + x1 + "," + y1 + " " + "C" + x2 + "," + y1 + " " + x1 + "," + y2 + " " + x2 + "," + y2;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _reactDraggable2.default,
	            {
	              ...
	              onStart: function onStart(e, position) {
	                return _this2.handleStart(e, position, "a1");
	              },
	              onDrag: function onDrag(e, position) {
	                return _this2.handleDrag(e, position, "a1");
	              },
	              onStop: function onStop(e, position) {
	                return _this2.handleStop(e, position, "a1");
	              } },
	            _react2.default.createElement(
	              'div',
	              null,
	              ...
	              _react2.default.createElement(
	                'div',
	                { onClick: this.clickA1Pin1.bind(this) },
	                'pin1'
	              ),
	              _react2.default.createElement(
	                'div',
	                { onClick: this.clickA1Pin2.bind(this) },
	                'pin2'
	              )
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { onClick: this.clickA2Pin1.bind(this) },
	                'pin1'
	              ),
	              _react2.default.createElement(
	                'div',
	                { onClick: this.clickA2Pin2.bind(this) },
	                'pin2'
	              )
	            )
	          )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('path', { id: 'curve', d: pstr, onClick: this.clickLine })
	          )
	        )
	      );
	    }
	    ...
	    key: 'clickLine',
	    value: function clickLine(e) {
	      console.log('clickLine');
	    }
	  }, {
	    key: 'clickA1Pin1',
	    value: function clickA1Pin1(e) {
	      console.log('a1pin1', e.clientX, e.clientY);
	      var pos = [e.clientX, e.clientY];
	      _pubsubJs2.default.publish("line.a1", pos);
	    }
	  }, {
	    key: 'clickA1Pin2',
	    value: function clickA1Pin2(e) {
	    ...
	    key: 'clickA2Pin1',
	    value: function clickA2Pin1(e) {
	      console.log('a2pin1', e.clientX, e.clientY);
	      var pos = [e.clientX, e.clientY];
	      _pubsubJs2.default.publish("line.a2", pos);
	    }
	  }, {
	    key: 'clickA2Pin2',
	    value: function clickA2Pin2(e) {
	    ...
	    key: 'handleStop',
	    value: function handleStop(e, position, tag) {
	      var lastX = position.lastX;
	      var lastY = position.lastY;

	      console.log(lastX, lastY);
	      _pubsubJs2.default.publish("pos." + tag, { x: lastX, y: lastY });
	    }
	  }]);
