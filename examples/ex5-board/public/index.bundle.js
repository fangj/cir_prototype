...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comp_layer = __webpack_require__(4);

	var _comp_layer2 = _interopRequireDefault(_comp_layer);

	var _line_layer = __webpack_require__(17);
	...
	var _reactDraggable = __webpack_require__(12);
	...
	var board = function (_React$Component) {
	  ...
	  function board(props) {
	    ...
	    _this.state = { layout: layout, //布局：包含元件的位置大小和线的位置
	  ...
	  _createClass(board, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.tokenPin = _pubsubJs2.default.subscribe('pin', function (msg, data) {
	        ...
	        if (!connecting) {
	          var from = data;
	          to = null;
	          me.setState({ connecting: true, from: from, to: to });
	        } else {
	    ...
	    value: function componentWillUnmount() {
	      _pubsubJs2.default.unsubscribe(this.tokenPin);
	      _pubsubJs2.default.unsubscribe(this.tokenDrag);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comp = __webpack_require__(5);
	...
	var comp_layer = function (_React$Component) {
	  _inherits(comp_layer, _React$Component);

	  function comp_layer(props) {
	    _classCallCheck(this, comp_layer);

	    return _possibleConstructorReturn(this, (comp_layer.__proto__ || Object.getPrototypeOf(comp_layer)).call(this, props));
	  }

	  _createClass(comp_layer, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        compnents.map(function (comp) {
	          return _react2.default.createElement(_comp2.default, { key: comp.id, data: comp });
	        })
	      );
	    }
	  }]);
	...
	comp_layer.propTypes = {
	  name: _react2.default.PropTypes.string
	};
	exports.default = comp_layer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pin = __webpack_require__(6);
	...
	var component = function (_React$Component) {
	  ...
	  _createClass(component, [{
	    ...
	    value: function render() {
	      ...
	      var style = { width: w * unit, height: h * unit };
	      return _react2.default.createElement(
	    ...
	    value: function handleDrop(e, position) {
	      ...
	      _pubsubJs2.default.publish("drag", { id: this.props.data.id, x: lastX, y: lastY });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pin = function (_React$Component) {
	  ...
	  function pin(props) {
	    ...
	    return _possibleConstructorReturn(this, (pin.__proto__ || Object.getPrototypeOf(pin)).call(this, props));
	  }
	...
	pin.propTypes = {
	  pos: _react2.default.PropTypes.array,
	  comp: _react2.default.PropTypes.string
	};
	exports.default = pin;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var line_layer = function (_React$Component) {
	  _inherits(line_layer, _React$Component);

	  function line_layer(props) {
	    _classCallCheck(this, line_layer);

	    return _possibleConstructorReturn(this, (line_layer.__proto__ || Object.getPrototypeOf(line_layer)).call(this, props));
	  }

	  _createClass(line_layer, [{
	    key: 'render',
	    value: function render() {
	      var _props$layout = this.props.layout;
	      var comps = _props$layout.comps;
	      ...
	      return _react2.default.createElement(
	        ...
	        !(connecting && to) ? null : _react2.default.createElement(_line2.default, { data: { from: _from, to: _to, id: "connecting" } })
	      );
	    }
	  }]);
	...
	line_layer.propTypes = {
	  name: _react2.default.PropTypes.string
	};
	exports.default = line_layer;
	function translateLines(comps, lines) {
	  var _lines = _.values(lines);
	...
	function translatePoint(point, comps) {
	  var comp = comps[point.comp];
	  var unit = 10;
	  var x = comp.x + point.pin[0] * unit + unit / 2;
	  var y = comp.y + point.pin[1] * unit + unit / 2;
	  return { x: x, y: y };
	}
	...
	var Line = function (_React$Component) {
	  ...
	  _createClass(Line, [{
	    ...
	    value: function render() {
	      ...
	      var color = _category2.default[idx];
	      return _react2.default.createElement('path', { id: id, d: pstr, style: { stroke: color }, onClick: function onClick() {
	          console.log("line:", id);
	        } });
	    }
	  }]);
